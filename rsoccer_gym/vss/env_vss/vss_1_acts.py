...
class VSSEnv1v1(VSSBaseEnv):
    """This environment controls a single robot in a VSS soccer League 1 match 
    ...
    def _get_commands(self, actions):
        ...
        commands.append(Robot(yellow=False, id=0, v_wheel0=v_wheel0,
                              v_wheel1=v_wheel1))
        velocities = list()
        velocities.append(v_wheel0)
        velocities.append(v_wheel1)
    ...
    def _get_initial_positions_frame(self):
        ...
        pos_frame.ball = Ball(x=-0.4, y=-0.4)
